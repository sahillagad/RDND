...
const Patra = () => {
  ...
  const handleUserStateInput = (
    ...
    if (event.target.name === "STATE_CODE") {
      ...
      event.target.name === "PARLIAMENT_CODE" &&
      user?.STATE_CODE !== ""
    ) {
      dispatch({
      ...
      dispatch(
        assemblyAction({
          ...
          lokSabha: event.target.value,
        })
      );
    }
  };

  const handleUserAspirationStateInput = (
    event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>
  ) => {
    dispatch({
  ...
  const handleUserVolunteerStateInput = (
    event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>
  ) => {
    dispatch({
  ...
  const handleCraeteUserState = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (
      ...
      user?.GENDER === "" ||
      user?.STATE_CODE === undefined ||
      user?.STATE_CODE === "" ||
      user?.PARLIAMENT_CODE === undefined ||
      user?.PARLIAMENT_CODE === "" ||
      user?.ASSEMBLY_CODE === undefined ||
      user?.ASSEMBLY_CODE === ""
    ) {
      i18n.language === "en"
      ...
      if (otp !== "") {
        if (otp?.length === 6) {
          ...
          if (OTPVerificationCheck === true) {
            dispatch(
              validateOTPAction({
                OTPValidation: { number: user?.MOBILE, otp: otp },
              })
            ).then((result: any) => {
              if (result?.payload?.success) {
                dispatch(
                  createUserAction({
                    user: { ...user, ROZGAAR_NYAY_CODE: otp },
                  })
                ).then((result: any) => {
    ...
    if (user?.MOBILE !== "" && user?.MOBILE !== undefined) {
      if (user?.MOBILE?.length === 10) {
        ...
        if (mobileNumberCheck === true) {
          dispatch(getOTPAction({ number: user?.MOBILE })).then(
            (result: any) => {
              if (result?.payload?.success) {
                setTime(60);
          ...
          i18n.language === "en"
            ? setErrorDetails("Please enter valid mobile number")
            : setErrorDetails("कृपया वैध मोबाइल नंबर दर्ज करें");
        }
      } else {
        i18n.language === "en"
          ? setErrorDetails("Please enter valid mobile number")
  ...
  const generatePDF = async () => {
    ...
    if (componentPDF.current) {
      try {
        ...
        componentPDF.current.style.backgroundColor = "#ffffff"; // hex code for white
        ...
        // Reset background color to its original state (if needed)
        componentPDF.current.style.backgroundColor = "";
    ...
    <>
          ...
          >
            <div className="modal-dialog  " role="document">
              <div className="modal-content shadow-lg ">
                <div className="modal-header bg-success p-1"></div>
        ...
        <>
         <div
          ...
          >
            <div className="modal-dialog  " role="document">
              <div className="modal-content shadow-lg ">
                <div className="modal-header bg-warning p-1"></div>
                <div className="modal-body border-0">
                  <h4 className="fs-4  ">
      ...
      {errorInfo.length !== 0 && errorInfo !== "" && (
        <>
          ...
          >
            <div className="modal-dialog " role="document">
              <div className="modal-content shadow-lg ">
                <div className="modal-header bg-danger p-1"></div>
                <div className="modal-body border-0">
                  <h4 className="fs-4  ">
      ...
      <div className="container-fluid  mt-4 "  ref={componentPDF}>
        <form
          ...
          onSubmit={(event) => handleCraeteUserState(event)}
        >
              ...
              <div className="container envelope  pt-0 pb-0 ">
                <div className="row  d-flex justify-content-between">
                  <div className="col-3  pt-2 pb-2  col-sm-3 col-lg-2  d-flex justify-content-center align-items-center">
                    <img src={IYC_logo} className="img-fluid imgh" alt="IYC_logo" />
                  </div>
                  ...
                  <div className="col-3 col-sm-3  pt-2 pb-2  col-lg-2 d-flex justify-content-center align-items-center">
                    <img
                      src={Indian_National_Congress_hand_logo}
                      className="img-fluid imgh"
                      alt="Indian_National_Congress_hand_logo"
                    />
                  </div>
                </div>
                <div className="row mt-3 ">
                  <div className="col-12 d-flex justify-content-center align-content-center">
                    <img
                      src={rozgar_nyay_patra_image1}
                      className="img-fluid"
                      alt="rozgar_nyay_patra_image1"
                    />
                  </div>
                </div>
                <div className="row bg-custom  pt-4 pb-4 d-flex justify-content-between ">
                  <div className="col-lg-6 d-flex justify-content-center align-items-center d-lg-flex flex-lg-column justify-content-lg-centercenter align-content-lg-end">
                  ...
                  <div className="col-lg-6  mt-4 mt-lg-0  text-white">
                    <div className="row ">
                      <h5 className="fs-4 " style={{ fontStretch: "expanded" }}>
                        {" "}
                        {t("patra-para1")}{" "}
                      </h5>
                    </div>
                    <div className="row ">
                      <div className="col-sm-6  mt-3 mt-sm-0  qr_Code_right_sidebar">
            ...
            <div className=" h-100 w-100 d-flex justify-content-center align-items-center">
              <div className="container envelope ">
                ...
                <div className="mb-3 mt-3 row">
                  ...
                  <label
                    htmlFor="inputName"
                    className="col-lg-1 col-form-label fw-bolder fs-6  text-custom mt-2 "
                  >
                    {t("Patra-Name")}
                    <span className="text-danger">*</span>{" "}
                  </label>
                  <div className="col-lg-11">
                    <input
                      type="text"
                      className={`form-control ps-0  rounded-0 shadow-none  mb-3   mb-3   ${
                        submitBtnPress === true &&
                        (user?.NAME === "" || user?.NAME === undefined)
                          ? "text-danger border-dotted-custom1 is-invalid "
                          : "border-custom1"
                      }`}
                      value={user?.NAME}
                      name="NAME"
                  ...
                  <div className="col-lg-5">
                    <input
                      type="email"
                      className="form-control ps-0 border-custom1 rounded-0 shadow-none  mb-3   mb-3"
                      value={user?.EMAIL}
                      name="EMAIL"
                      onChange={(event) => handleUserStateInput(event)}
                      id="inputEmail"
                  ...
                  <div className="col-lg-5   mb-3 ">
                    <select
                      ...
                      className={`form-select shadow-none rounded-0
                             ${
                               ...
                               (user?.STATE_CODE === "" ||
                                 user?.STATE_CODE === undefined)
                                 ? "form-select-custom1  is-invalid "
                                 : "form-select-custom"
                             }`}
                      id="inputState"
                      name="STATE_CODE"
                    ...
                    >
                      ...
                      {stateList?.map((stateInfo, index) => {
                        return (
                          <option key={index} value={stateInfo.code}>
                            {stateInfo.name}
                          </option>
                        );
                      })}
                  ...
                  <label
                    htmlFor="inputLokSabha"
                    className="col-lg-1 col-form-label fw-bolder fs-6  text-custom  "
                  >
                    {t("Patra-Parliamentary-Constituency")}
                    <span className="text-danger">*</span>{" "}
                  </label>
                  <div className="col-lg-11   mb-3 ">
                    ...
                    >
                      ...
                      {lokSabhaList?.map((lokSabhaInfo, index) => {
                        return (
                          <option key={index} value={lokSabhaInfo.LS_CODE}>
                            {lokSabhaInfo.LS_NAME}
                          </option>
                        );
                      })}
                    </select>
                  ...
                  <label
                    htmlFor="inputVidhanSabha"
                    className="col-lg-1 col-form-label fw-bolder fs-6  text-custom  "
                  >
                    {t("Patra-Assembly-Constituency")}
                    <span className="text-danger">*</span>{" "}
                  </label>
                  <div className="col-lg-11   mb-3 ">
                    <select
                    ...
                    >
                      ...
                      {assemblyList?.map((assemblyInfo, index) => {
                        return (
                          <option key={index} value={assemblyInfo.AS_CODE}>
                            {assemblyInfo.AS_NAME}
                          </option>
                        );
                      })}
                    </select>
                  ...
                  <label
                    ...
                    className="col-lg-2 col-form-label fw-bolder fs-6  text-custom  "
                  >
                    {t("Patra-Highest-Educational-Qualification")}{" "}
                  </label>
                  <div className="col-lg-10   mb-3 ">
                    ...
                    >
                      ...
                      <option value="Less_Than_10th">Less Than 10th</option>
              ...
              <div className="container envelope">
                <div className="row  ">
                  <div className="col-md-12 ">
                    <h6 className="text-custom fs-6 fw-bolder">
                      {" "}
                      {t("Patra-Select-Aspiring")}
                    </h6>
                  </div>
                </div>
                  ...
                  <div className="col-sm-4">
                    <div className="form-check">
                      <input
                        ...
                        onChange={(event) =>
                          handleUserAspirationStateInput(event)
                        }
                      />
                      <label
                        className="form-check-label text-custom"
                  ...
                  <div className="col-sm-4">
                    <div className="form-check">
                      <input
                        ...
                        checked={
                          user?.ASPIRATION?.Accountant_Marketing_Data_Entry
                        }
                        onChange={(event) =>
                          handleUserAspirationStateInput(event)
                        }
                      ...
                      >
                        {t("Accountant-Marketing-Data-Entry")}{" "}
                      </label>
                    </div>
                    <div className="form-check">
                      <input
                  ...
                  <div className="col-sm-12">
                    ...
                    <div className="form-check mt-2">
                      <input
                        ...
                        onChange={(event) =>
                          handleUserVolunteerStateInput(event)
                        }
  ...
  */}
                ...
                <div className="row  mt-3 d-flex justify-content-end">
                  <div className="col-7 col-sm-4  col-md-4 col-lg-3  text-center">
                    <small className="text-custom fs-6 fw-bolder ">
                      {t("patra-para5")}
                    </small>
                    ...
                    <input
                      disabled={true}
                      type="text"
                      className="form-control fs-5 text-center ps-0 border-custom1 rounded-0 shadow-none  mb-3  signature mb-3"
                      value={user?.NAME}
                      required
                      id="inputName"
                      aria-describedby="helpId"
                ...
                <div className="row   d-flex justify-content-center align-items-center">
                  <div className="col-12 text-center mt-4">
                    <button
                      ...
                      type="submit"
                      onClick={() => setSubmitBtnPress(true)}
                    >
                      {t("Submit")}{" "}
                    </button>
                  </div>
              ...
              <div className="container envelope" >
                <div className="row  mt-4 mb-4">
                  <div className="col-md-6 border-custom">
                    <div
                      className="row  d-flex justify-content-between text-custom"
                      style={{ fontSize: "13px" }}
                    >
                  ...
                  <div className="col-md-6 text-end ">
                    <div className="row d-flex ">
                      <div className="col-sm-12 mb-2 d-block d-md-none">
                        <div className="stamp ">
                          <img
                            src={BharatJODOYatra1}
                            className=""
                            alt="BharatJODOYatra1"
                            height={60}
                            width={60}
                          />
                        </div>
                      ...
                      <div className="col-12 text-start mt-4">
                        <small className="text-custom fs-6">
                          {t("patra-para13")}
                        </small>{" "}
                        <br />
                        <img
                          src={Signature_of_Rahul_Gandhi}
                          alt="Signature_of_Rahul_Gandhi"
                          width={100}
                          height={50}
                        />
                        <br />
                        <h6 className="fw-bolder text-custom mb-0">
                          {t("patra-para14")}
                        </h6>
                      </div>
                    </div>
