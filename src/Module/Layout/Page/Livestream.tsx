  ...
  return (
    <React.Fragment>
      ...
      <div className="container-fluid ">
        <div className="row ">
          <div
            className="col-sm-12 w-100 p-0 m-0 d-flex flex-column  justify-content-center align-items-start "
            style={{ height: "500px" }}
          >
            <iframe
              className="w-100 h-100"
              src="https://www.youtube.com/embed/tssYikj1srE"
              title="LIVE: Bharat Jodo Nyay Yatra"
              frameBorder="0"
        ...
        >
          <div className="col-sm-10 m-auto">
            <h6 className="fw-bold fs-3 text-center text-uppercase">
              {" "}
              {t("resources")}
            </h6>
                ...
                {i18n.language === "en" ? (
                  <>
                    <div className="d-flex flex-column justify-content-center align-items-center">
                      ...
                      <button
                        className="btn btn-custom mt-2"
                        onClick={handleDownloadstickereng}
                      >
                        Download Stickers{" "}
                      </button>
                    </div>
                  ...
                  <>
                    <div className="d-flex flex-column justify-content-center align-items-center">
                      ...
                      <button
                        className="btn btn-custom mt-2"
                        onClick={handleDownloadstickerhin}
                      >
                        डाउनलोड स्टिकर
                      </button>
                    </div>
